...
import { Input, Button, Badge } from '@/presentation/components/ui';
import { UserCard, UserTable, UserGridSkeleton, UserTableSkeleton } from '@/presentation/components/users';
import { ErrorState, EmptyState } from '@/presentation/components/common';
import {
  SearchIcon,
  RefreshIcon,
  GridIcon,
...
import type { SortField } from '@/domain';
...
export function UsersDashboard() {
  ...
  const filteredAndSortedUsers = useAppSelector(selectFilteredAndSortedUsers);
